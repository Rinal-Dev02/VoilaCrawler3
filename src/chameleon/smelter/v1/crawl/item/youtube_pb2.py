...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n-chameleon/smelter/v1/crawl/item/youtube.proto\x12\x1f\x63hameleon.smelter.v1.crawl.item\x1a\x1e\x63hameleon/api/media/data.proto\x1a\x1d\x63hameleon/api/http/data.proto\"\xa5\x08\n\x07Youtube\x1aM\n\x06Source\x12\n\n\x02id\x18\x01 \x01(\t\x12\x10\n\x08\x63rawlUrl\x18\x02 \x01(\t\x12\x11\n\tsourceUrl\x18\x05 \x01(\t\x12\x12\n\npublishUtc\x18\x0f \x01(\x03\x1a\xbd\x02\n\x07\x43hannel\x12\n\n\x02id\x18\x01 \x01(\t\x12\x14\n\x0c\x63\x61nonicalUrl\x18\x02 \x01(\t\x12\x10\n\x08username\x18\x03 \x01(\t\x12\r\n\x05title\x18\x04 \x01(\t\x12\x0e\n\x06\x61vatar\x18\x05 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x06 \x01(\t\x12\x0f\n\x07\x63ountry\x18\x07 \x01(\t\x12\x45\n\x05stats\x18\x0b \x01(\x0b\x32\x36.chameleon.smelter.v1.crawl.item.Youtube.Channel.Stats\x12\x14\n\x0cpublishedUtc\x18\x0f \x01(\x03\x1a\\\n\x05Stats\x12\x16\n\x0esubscribeCount\x18\x01 \x01(\x05\x12\x12\n\nvideoCount\x18\x02 \x01(\x05\x12\x11\n\tviewCount\x18\x03 \x01(\x05\x12\x14\n\x0c\x63ommentCount\x18\x05 \x01(\x05\x1a\x8a\x05\n\x05Video\x12?\n\x06source\x18\x02 \x01(\x0b\x32/.chameleon.smelter.v1.crawl.item.Youtube.Source\x12\r\n\x05title\x18\x04 \x01(\t\x12\x13\n\x0b\x64\x65scription\x18\x05 \x01(\t\x12\x41\n\x07\x63hannel\x18\x06 \x01(\x0b\x32\x30.chameleon.smelter.v1.crawl.item.Youtube.Channel\x12\x45\n\x06player\x18\x08 \x01(\x0b\x32\x35.chameleon.smelter.v1.crawl.item.Youtube.Video.Player\x12L\n\x07headers\x18\x0f \x03(\x0b\x32;.chameleon.smelter.v1.crawl.item.Youtube.Video.HeadersEntry\x12\x43\n\x05stats\x18\x15 \x01(\x0b\x32\x34.chameleon.smelter.v1.crawl.item.Youtube.Video.Stats\x12\x12\n\ncrawledUtc\x18\x1f \x01(\x03\x12\x12\n\nexpiresUtc\x18  \x01(\x03\x1aY\n\x05Stats\x12\x11\n\tviewCount\x18\x03 \x01(\x05\x12\x14\n\x0c\x63ommentCount\x18\x05 \x01(\x05\x12\x11\n\tlikeCount\x18\x06 \x01(\x05\x12\x14\n\x0c\x64islikeCount\x18\x07 \x01(\x05\x1aL\n\x06Player\x12\x11\n\tembedHtml\x18\x01 \x01(\t\x12/\n\x05video\x18\x02 \x01(\x0b\x32 .chameleon.api.media.Media.Video\x1a.\n\x0cHeadersEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01\x42&Z$chameleon/smelter/v1/crawl/item;itemb\x06proto3'
  ,
...
_YOUTUBE_VIDEO_STATS = _descriptor.Descriptor(
  name='Stats',
  full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Stats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='viewCount', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Stats.viewCount', index=0,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='commentCount', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Stats.commentCount', index=1,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='likeCount', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Stats.likeCount', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dislikeCount', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Stats.dislikeCount', index=3,
...
_YOUTUBE_VIDEO_PLAYER = _descriptor.Descriptor(
  name='Player',
  full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Player',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='embedHtml', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Player.embedHtml', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='video', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.Player.video', index=1,
...
_YOUTUBE_VIDEO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='player', full_name='chameleon.smelter.v1.crawl.item.Youtube.Video.player', index=4,
  ...
  nested_types=[_YOUTUBE_VIDEO_STATS, _YOUTUBE_VIDEO_PLAYER, _YOUTUBE_VIDEO_HEADERSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_YOUTUBE = _descriptor.Descriptor(
  ...
  nested_types=[_YOUTUBE_SOURCE, _YOUTUBE_CHANNEL, _YOUTUBE_VIDEO, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_YOUTUBE_VIDEO_STATS.containing_type = _YOUTUBE_VIDEO
_YOUTUBE_VIDEO_PLAYER.fields_by_name['video'].message_type = chameleon_dot_api_dot_media_dot_data__pb2._MEDIA_VIDEO
_YOUTUBE_VIDEO_PLAYER.containing_type = _YOUTUBE_VIDEO
...
_YOUTUBE_VIDEO.fields_by_name['player'].message_type = _YOUTUBE_VIDEO_PLAYER
_YOUTUBE_VIDEO.fields_by_name['headers'].message_type = _YOUTUBE_VIDEO_HEADERSENTRY
_YOUTUBE_VIDEO.fields_by_name['stats'].message_type = _YOUTUBE_VIDEO_STATS
...
Youtube = _reflection.GeneratedProtocolMessageType('Youtube', (_message.Message,), {
  ...
  'Video' : _reflection.GeneratedProtocolMessageType('Video', (_message.Message,), {
    ...
    'Stats' : _reflection.GeneratedProtocolMessageType('Stats', (_message.Message,), {
      'DESCRIPTOR' : _YOUTUBE_VIDEO_STATS,
      '__module__' : 'chameleon.smelter.v1.crawl.item.youtube_pb2'
      # @@protoc_insertion_point(class_scope:chameleon.smelter.v1.crawl.item.Youtube.Video.Stats)
      })
    ,

    'Player' : _reflection.GeneratedProtocolMessageType('Player', (_message.Message,), {
      'DESCRIPTOR' : _YOUTUBE_VIDEO_PLAYER,
      '__module__' : 'chameleon.smelter.v1.crawl.item.youtube_pb2'
      # @@protoc_insertion_point(class_scope:chameleon.smelter.v1.crawl.item.Youtube.Video.Player)
      })
    ,
...
_sym_db.RegisterMessage(Youtube.Video.Stats)
_sym_db.RegisterMessage(Youtube.Video.Player)
