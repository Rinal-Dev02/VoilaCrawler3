...
var file_chameleon_smelter_v1_crawl_service_message_proto_rawDesc = []byte{
	...
	0x61, 0x22, 0xb9, 0x05, 0x0a, 0x0c, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x64, 0x61, 0x74, 0x61, 0x42, 0x22, 0x5a, 0x20, 0x63, 0x68, 0x61, 0x6d, 0x65, 0x6c, 0x65, 0x6f,
...
var file_chameleon_smelter_v1_crawl_service_message_proto_goTypes = []interface{}{
	...
	(*FetchRequest_Options)(nil),      // 13: chameleon.smelter.v1.crawl.FetchRequest.Options
	nil,                               // 14: chameleon.smelter.v1.crawl.FetchRequest.CustomHeadersEntry
	...
	(*Item)(nil),                      // 18: chameleon.smelter.v1.crawl.Item
}
var file_chameleon_smelter_v1_crawl_service_message_proto_depIdxs = []int32{
	...
	14, // 5: chameleon.smelter.v1.crawl.FetchRequest.customHeaders:type_name -> chameleon.smelter.v1.crawl.FetchRequest.CustomHeadersEntry
	17, // 6: chameleon.smelter.v1.crawl.FetchRequest.customCookies:type_name -> chameleon.api.http.Cookie
	13, // 7: chameleon.smelter.v1.crawl.FetchRequest.options:type_name -> chameleon.smelter.v1.crawl.FetchRequest.Options
	18, // 8: chameleon.smelter.v1.crawl.FetchResponse.data:type_name -> chameleon.smelter.v1.crawl.Item
