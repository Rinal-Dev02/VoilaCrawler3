...
type RequestHistory struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" xorm:"varchar(64) pk"`
	// Timestamp
	Timestamp int64 `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty" xorm:"pk"`
	// StoreId
	StoreId string `protobuf:"bytes,3,opt,name=storeId,proto3" json:"storeId,omitempty" xorm:"varchar(64) index"`
	// StatusCode
...
func (m *RequestHistory) GetStatusCode() int32 {
	if m != nil {
		return m.StatusCode
	}
	return 0
...
var fileDescriptor_7f73548e33e655fe = []byte{
	...
	,
}
...
func (m *RequestHistory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StatusCode != 0 {
		i = encodeVarintRequest(dAtA, i, uint64(m.StatusCode))
		i--
		dAtA[i] = 0x30
	}
	if len(m.StoreId) > 0 {
...
func (m *RequestHistory) Size() (n int) {
	...
	if m.StatusCode != 0 {
		n += 1 + sovRequest(uint64(m.StatusCode))
	}
	l = len(m.ErrMsg)
	if l > 0 {
		n += 1 + l + sovRequest(uint64(l))
