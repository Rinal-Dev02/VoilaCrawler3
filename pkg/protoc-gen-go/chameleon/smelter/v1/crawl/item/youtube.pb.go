...
type Youtube_Video struct {
	...
	// Player
	Player *Youtube_Video_Player `protobuf:"bytes,8,opt,name=player,proto3" json:"player,omitempty"`
	// Header
	...
	// Stats
	Stats *Youtube_Video_Stats `protobuf:"bytes,21,opt,name=stats,proto3" json:"stats,omitempty"`
	// CrawledUtc
...
func (x *Youtube_Video) GetPlayer() *Youtube_Video_Player {
	if x != nil {
		return x.Player
	}
	return nil
...
func (x *Youtube_Video) GetStats() *Youtube_Video_Stats {
	if x != nil {
		return x.Stats
	}
	return nil
...
// Stats
type Youtube_Video_Stats struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// DislikeCount
	DislikeCount int32 `protobuf:"varint,7,opt,name=dislikeCount,proto3" json:"dislikeCount,omitempty"`
}

func (x *Youtube_Video_Stats) Reset() {
	*x = Youtube_Video_Stats{}
	if protoimpl.UnsafeEnabled {
...
func (x *Youtube_Video_Stats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Youtube_Video_Stats) ProtoMessage() {}

func (x *Youtube_Video_Stats) ProtoReflect() protoreflect.Message {
	mi := &file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Youtube_Video_Stats.ProtoReflect.Descriptor instead.
func (*Youtube_Video_Stats) Descriptor() ([]byte, []int) {
	return file_chameleon_smelter_v1_crawl_item_youtube_proto_rawDescGZIP(), []int{0, 2, 0}
}

func (x *Youtube_Video_Stats) GetViewCount() int32 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
func (x *Youtube_Video_Stats) GetCommentCount() int32 {
	if x != nil {
		return x.CommentCount
	}
	return 0
...
func (x *Youtube_Video_Stats) GetLikeCount() int32 {
	if x != nil {
		return x.LikeCount
	}
	return 0
...
func (x *Youtube_Video_Stats) GetDislikeCount() int32 {
	if x != nil {
...
// Player
type Youtube_Video_Player struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// EmbedHtml
	EmbedHtml string `protobuf:"bytes,1,opt,name=embedHtml,proto3" json:"embedHtml,omitempty"`
	// Video
	Video *media.Media_Video `protobuf:"bytes,2,opt,name=video,proto3" json:"video,omitempty"`
}

func (x *Youtube_Video_Player) Reset() {
	*x = Youtube_Video_Player{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Youtube_Video_Player) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Youtube_Video_Player) ProtoMessage() {}

func (x *Youtube_Video_Player) ProtoReflect() protoreflect.Message {
	mi := &file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Youtube_Video_Player.ProtoReflect.Descriptor instead.
func (*Youtube_Video_Player) Descriptor() ([]byte, []int) {
	return file_chameleon_smelter_v1_crawl_item_youtube_proto_rawDescGZIP(), []int{0, 2, 1}
}

func (x *Youtube_Video_Player) GetEmbedHtml() string {
	if x != nil {
		return x.EmbedHtml
	}
	return ""
...
func (x *Youtube_Video_Player) GetVideo() *media.Media_Video {
	if x != nil {
		return x.Video
	}
	return nil
...
var file_chameleon_smelter_v1_crawl_item_youtube_proto_rawDesc = []byte{
	...
	0xfc, 0x0a, 0x0a, 0x07, 0x59, 0x6f, 0x75, 0x74, 0x75, 0x62, 0x65, 0x1a, 0x72, 0x0a, 0x06, 0x53,
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0xb0, 0x06, 0x0a, 0x05,
	0x56, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x47, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x63, 0x68, 0x61, 0x6d, 0x65, 0x6c, 0x65, 0x6f,
	0x6e, 0x2e, 0x73, 0x6d, 0x65, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x63, 0x72, 0x61,
	0x77, 0x6c, 0x2e, 0x69, 0x74, 0x65, 0x6d, 0x2e, 0x59, 0x6f, 0x75, 0x74, 0x75, 0x62, 0x65, 0x2e,
	...
	,
	...
	,
...
var file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_chameleon_smelter_v1_crawl_item_youtube_proto_goTypes = []interface{}{
	...
	(*Youtube_Video)(nil),         // 3: chameleon.smelter.v1.crawl.item.Youtube.Video
	(*Youtube_Channel_Stats)(nil), // 4: chameleon.smelter.v1.crawl.item.Youtube.Channel.Stats
	(*Youtube_Video_Stats)(nil),   // 5: chameleon.smelter.v1.crawl.item.Youtube.Video.Stats
	(*Youtube_Video_Player)(nil),  // 6: chameleon.smelter.v1.crawl.item.Youtube.Video.Player
	nil,                           // 7: chameleon.smelter.v1.crawl.item.Youtube.Video.HeadersEntry
	(*media.Media_Video)(nil),     // 8: chameleon.api.media.Media.Video
}
var file_chameleon_smelter_v1_crawl_item_youtube_proto_depIdxs = []int32{
	4, // 0: chameleon.smelter.v1.crawl.item.Youtube.Channel.stats:type_name -> chameleon.smelter.v1.crawl.item.Youtube.Channel.Stats
	...
	6, // 3: chameleon.smelter.v1.crawl.item.Youtube.Video.player:type_name -> chameleon.smelter.v1.crawl.item.Youtube.Video.Player
	7, // 4: chameleon.smelter.v1.crawl.item.Youtube.Video.headers:type_name -> chameleon.smelter.v1.crawl.item.Youtube.Video.HeadersEntry
	5, // 5: chameleon.smelter.v1.crawl.item.Youtube.Video.stats:type_name -> chameleon.smelter.v1.crawl.item.Youtube.Video.Stats
	8, // 6: chameleon.smelter.v1.crawl.item.Youtube.Video.Player.video:type_name -> chameleon.api.media.Media.Video
...
func file_chameleon_smelter_v1_crawl_item_youtube_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Youtube_Video_Stats); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chameleon_smelter_v1_crawl_item_youtube_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Youtube_Video_Player); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
